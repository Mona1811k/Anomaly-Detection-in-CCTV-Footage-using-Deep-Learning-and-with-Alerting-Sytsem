...
#             password__data = retrivequery1(query, values)
#             if password__data:
#                 stored_password_data=password__data[0][0]
...
def upload():
    if request.method == 'POST':
        ...
        send_email_with_attachment("monakonakalla2003@gmail.com", saved_frame_path)
...
import os
import cv2
sender_address = "monasatwika2003@gmail.com"
sender_pass = "yyrvxaiswcjlkudm"  # App password
def send_email_with_attachment(owner_email, image_path):
    try:
        ...
        new_message['To'] = "monakonakalla2003@gmail.com"
